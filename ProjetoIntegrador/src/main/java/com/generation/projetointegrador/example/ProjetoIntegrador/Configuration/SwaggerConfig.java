package com.generation.projetointegrador.example.ProjetoIntegrador.Configuration;
...
public class SwaggerConfig {
	...
	public OpenAPI springProjetoIntegradorOpenAPI(){
		return new OpenAPI()
				...
				.contact(new Contact()
						.name ("Grupo 8 - Turma 42")
						.url("")
						.email("")))
				
				.externalDocs(new ExternalDocumentation()
						.description("Github")
						.url("https://github.com/gbdslx-dev/Projeto-Integrador"));
	}
